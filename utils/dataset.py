...
class TrainDataset(Dataset):
    ...
    def __getitem__(self, idx):
        ...
        # t = file_name.split("_")
        # print(t)
        path = os.path.join("/content/NUS-WIDE/images/", file_name)
...
class ValDataset(Dataset):
    ...
    def __getitem__(self, idx):
        ...
        labels_1006 =  np.int32(self.train_features.get(prev+'-labels'))
        labels_81 =  np.int32(self.train_features.get(prev+'-labels_81'))
